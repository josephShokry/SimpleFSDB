...
def  parseInput():
    ...
    parser.add_argument("-dow", "--disableoverwrite", type = bool, default = False, help = "when it is true it will over write in the stored row, if it isn't it will raise exception if the row is already exist")

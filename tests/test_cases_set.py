...
class test_set_function(unittest.TestCase):
    ...
    def test_set_7(self):# row exist and disable overwrite is ture 
        # command = SetCommand("csed2025", "Students","{\"id\": \"5\",\"first_name\": \"joseph\",\"last_name\": \"shokry\",\"age\": \"20\",\"gender\": \"male\"}" , True,None)
        # try :command.execute()
        # except WrongInput:
        #     pass
        # with self.assertRaises(expected_exception = WrongInput) as cm:
        #     command.execute()
    ...
    #     os.system(main_path)
    #     cmd = "python source\main.py -cmd set -db csed2025 -tb Studenttts -val "'{\"id\": \"5\",\"first_name\": \"joseph\",\"last_name\": \"shokry\",\"age\": \"20\",\"gender\": \"male\"}'""
    #     try:
    #         os.system(cmd)
    #     except TableNotExist:
    #         pass
